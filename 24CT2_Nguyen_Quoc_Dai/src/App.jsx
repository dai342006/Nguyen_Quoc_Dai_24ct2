        ...
        <div className="profile-layout">
          <section className="profile-card">
            <div className="profile-top">
              ...
              <div>
                <h2>Nguyễn Minh Duy</h2>
                <p>Lập trình viên & Web Developer</p>
                <div className="rating-big">⭐ 4.9 <span>• Đà Nẵng</span></div>
              </div>
            </div>
            ...
            <p>
              Xin chào! Mình chuyên xây dựng website bằng ReactJS, thiết kế giao
              diện và tối ưu trải nghiệm người dùng.
            </p>
